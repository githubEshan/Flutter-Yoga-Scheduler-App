...
Widget textField({text,TextEditingController? controller,Function? validator,
...
Widget myTextField({text, String? icon, bool, TextEditingController? controller,Function? validator, required Color colorText}) {
  return Container(
    height: 45,
    child: TextFormField(
...
Widget elevatedButton({text, Function? onpress}) {
  return ElevatedButton(
    style: ButtonStyle(
      ...
      backgroundColor: MaterialStateProperty.all<Color>(AppColors.deepPurple),
    ),
    onPressed: () {
      onpress!();
    },
